...
export const metadata = seo({
  ...
  description: 'Oversikt over regnskapsførere i Alna, Oslo. Komplett liste med adresser og kontaktinfo. Data fra Brønnøysundregistrene.',
...
export default function RegnskapsforerAlnaPage() {
  ...
  return (
    <div className="container">
      ...
      <FAQ items={[
        { q: 'Hvor mange regnskapsfirmaer er det i Alna?', a: `Det er ${firms.length} registrerte regnskapsfirmaer i Alna ifølge Brønnøysundregistrene.` },
