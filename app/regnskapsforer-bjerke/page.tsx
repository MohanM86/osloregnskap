  ...
  return (
    <div className="container">
      ...
      <section className="hero" style={{ padding: '1.5rem 0 2rem' }}>
        <h1 className="animate-in animate-in-1">Regnskapsfører Bjerke Oslo</h1>
        <p className="animate-in animate-in-2">
          {firms.length} registrerte regnskapsfirmaer i Bjerke i Oslo.
        </p>
      </section>

      <div className="stats-row animate-in animate-in-3">
        <AnimatedStat value={firms.length} colorClass="stat-card-green" label="Firmaer i Bjerke" />
      ...
      <section style={{ marginTop: '2rem' }} className="animate-in animate-in-4">
        ...
        {firms.length === 0 && (
          <p style={{ color: 'var(--fg-muted)' }}>
            Ingen regnskapsfirmaer registrert i Bjerke. <Link href="/firmaer/">Se alle i Oslo</Link>.
          </p>
        )}
      </section>
