...
export const metadata = seo({
  ...
  description: 'Oversikt over regnskapsførere i Grünerløkka, Oslo. Komplett liste med adresser og kontaktinfo. Data fra Brønnøysundregistrene.',
...
export default function RegnskapsforerGrunerlokkaPage() {
  ...
  return (
    ...
    about: { '@type': 'City', name: 'Oslo' },
      ...
      <h1 style={{ fontSize: '2rem', marginBottom: '1rem' }}>Regnskapsfører Grünerløkka Oslo</h1>

      <p style={{ fontSize: '1.05rem', color: 'var(--muted)', marginBottom: '1.5rem' }}>
        Det finnes {firms.length} registrerte regnskapsfirmaer i Grünerløkka i Oslo.
        Grünerløkka har i løpet av de siste tiårene utviklet seg til en av Oslos mest dynamiske bydeler for småbedrifter og gründervirksomhet. Bydelen har mange moderne regnskapsfirmaer som betjener oppstartsbedrifter og kreative næringer.
      </p>

      <div className="stat-grid">
        <div className="stat-box">
          <span className="num">{firms.length}</span>
          <span className="label">Regnskapsfirmaer i Grünerløkka</span>
        </div>
        <div className="stat-box">
      ...
      <section style={{ marginTop: '2rem' }}>
        ...
        {firms.length === 0 && (
          <p style={{ color: 'var(--muted)' }}>
            Det er foreløpig ingen regnskapsfirmaer registrert med forretningsadresse i Grünerløkka.
      ...
      <SchemaFAQ items={[
        { q: 'Hvor mange regnskapsfirmaer er det i Grünerløkka?', a: `Det er ${firms.length} registrerte regnskapsfirmaer i Grünerløkka ifølge Brønnøysundregistrene.` },
