...
export const metadata = seo({
  ...
  description: 'Oversikt over regnskapsførere i Grorud, Oslo. Komplett liste med adresser og kontaktinfo. Data fra Brønnøysundregistrene.',
...
export default function RegnskapsforerGrorudPage() {
  ...
  return (
    ...
    about: { '@type': 'City', name: 'Oslo' },
      ...
      <SchemaFAQ items={[
        { q: 'Hvor mange regnskapsfirmaer er det i Grorud?', a: `Det er ${firms.length} registrerte regnskapsfirmaer i Grorud ifølge Brønnøysundregistrene.` },
