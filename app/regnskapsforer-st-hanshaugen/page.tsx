...
export const metadata = seo({
  title: 'Regnskapsfører St. Hanshaugen Oslo — Finn regnskapsfører i St. Hanshaugen',
  description: 'Oversikt over regnskapsførere i St. Hanshaugen, Oslo. Komplett liste med adresser og kontaktinfo. Data fra Brønnøysundregistrene.',
  path: '/regnskapsforer-st-hanshaugen/',
});

export default function RegnskapsforerSthanshaugenPage() {
  const allFirms = getAllFirms();
  const firms = allFirms.filter(f => f.bydel === 'St. Hanshaugen');
  const otherBydeler = Object.entries(BYDELER_INFO)
    .filter(([name]) => name !== 'St. Hanshaugen')
    .slice(0, 8);
  ...
  return (
    ...
    '@type': 'CollectionPage',
    name: 'Regnskapsfører St. Hanshaugen Oslo',
    description: `Oversikt over regnskapsførere i St. Hanshaugen, Oslo`,
    url: 'https://osloregnskap.no/regnskapsforer-st-hanshaugen/',
    ...
    about: { '@type': 'City', name: 'Oslo' },
      ...
      <h1 style={{ fontSize: '2rem', marginBottom: '1rem' }}>Regnskapsfører St. Hanshaugen Oslo</h1>

      <p style={{ fontSize: '1.05rem', color: 'var(--muted)', marginBottom: '1.5rem' }}>
        Det finnes {firms.length} registrerte regnskapsfirmaer i St. Hanshaugen i Oslo.
        St. Hanshaugen er en sentrumsnær bydel med blanding av boliger og kontorer. Bydelen har et variert næringsliv med flere regnskapsfirmaer.
      </p>

      <div className="stat-grid">
        <div className="stat-box">
          <span className="num">{firms.length}</span>
          <span className="label">Regnskapsfirmaer i St. Hanshaugen</span>
        </div>
        <div className="stat-box">
      ...
      <section style={{ marginTop: '2rem' }}>
        <h2 style={{ fontSize: '1.4rem', marginBottom: '1rem' }}>
          Alle regnskapsfirmaer i St. Hanshaugen ({firms.length})
        </h2>
        ...
        {firms.length === 0 && (
          <p style={{ color: 'var(--muted)' }}>
            Det er foreløpig ingen regnskapsfirmaer registrert med forretningsadresse i St. Hanshaugen.
      ...
      <SchemaFAQ items={[
        { q: 'Hvor mange regnskapsfirmaer er det i St. Hanshaugen?', a: `Det er ${firms.length} registrerte regnskapsfirmaer i St. Hanshaugen ifølge Brønnøysundregistrene.` },
        { q: 'Må jeg bruke regnskapsfører i St. Hanshaugen?', a: 'Nei, du trenger ikke bruke en regnskapsfører i din egen bydel. Med moderne skybaserte løsninger kan regnskapsføreren jobbe fra hvor som helst. Mange foretrekker likevel en lokal regnskapsfører for enklere kommunikasjon.' },
        { q: 'Hva koster regnskapsfører i St. Hanshaugen?', a: 'Prisene er omtrent de samme som ellers i Oslo. Typisk 500–1 500 kroner per time, eller 1 000–15 000 kroner per måned avhengig av bedriftsstørrelse og behov.' },
      ]} />
      <FAQAccordion items={[
        { q: 'Hvor mange regnskapsfirmaer er det i St. Hanshaugen?', a: `Det er ${firms.length} registrerte regnskapsfirmaer i St. Hanshaugen ifølge Brønnøysundregistrene.` },
        { q: 'Må jeg bruke regnskapsfører i St. Hanshaugen?', a: 'Nei, du trenger ikke bruke en regnskapsfører i din egen bydel. Med moderne skybaserte løsninger kan regnskapsføreren jobbe fra hvor som helst. Mange foretrekker likevel en lokal regnskapsfører for enklere kommunikasjon.' },
      ...
      <InternalLinks exclude={`/regnskapsforer-st-hanshaugen/`} />
    </div>
  );
}
