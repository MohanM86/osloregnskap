...
export const metadata = seo({
  ...
  description: 'Oversikt over regnskapsførere i Sagene, Oslo. Komplett liste med adresser og kontaktinfo. Data fra Brønnøysundregistrene.',
  ...
  return (
    <div className="container">
      ...
      <section style={{ marginTop: '2rem' }}>
        <h2 style={{ fontSize: '1.4rem', marginBottom: '1rem' }}>Om Sagene som næringsområde</h2>
        <p style={{ marginBottom: '1rem' }}>
          Sagene i Oslo dekker områdene Sagene, Bjølsen, Ila og Iladalen.
        ...
        <p>
          Regnskapsfirmaer i Sagene tilbyr typisk tjenester som løpende bokføring,
      ...
      <FAQAccordion items={[
        { q: 'Hvor mange regnskapsfirmaer er det i Sagene?', a: `Det er ${firms.length} registrerte regnskapsfirmaer i Sagene ifølge Brønnøysundregistrene.` },
