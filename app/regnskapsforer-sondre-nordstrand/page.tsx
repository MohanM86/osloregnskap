...
export const metadata = seo({
  ...
  description: 'Oversikt over regnskapsførere i Søndre Nordstrand, Oslo. Komplett liste med adresser og bydelsinformasjon. ',
...
export default function RegnskapsforerSondrenordstrandPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'CollectionPage',
    name: 'Regnskapsfører Søndre Nordstrand Oslo',
    description: `Oversikt over regnskapsførere i Søndre Nordstrand, Oslo`,
    url: 'https://osloregnskap.no/regnskapsforer-sondre-nordstrand/',
  ...
  return (
    <div className="container">
      ...
      <section className="hero" style={{ padding: '1.5rem 0 2rem' }}>
        <h1 className="animate-in animate-in-1">Regnskapsfører Søndre Nordstrand Oslo</h1>
        <p className="animate-in animate-in-2">
          {firms.length} registrerte regnskapsfirmaer i Søndre Nordstrand i Oslo.
        </p>
      </section>

      <div className="stats-row animate-in animate-in-3">
        <AnimatedStat value={firms.length} colorClass="stat-card-green" label="Firmaer i Søndre Nordstrand" />
      ...
      <section style={{ marginTop: '2rem' }} className="animate-in animate-in-4">
        ...
        {firms.length === 0 && (
          <p style={{ color: 'var(--fg-muted)' }}>
            Ingen regnskapsfirmaer registrert i Søndre Nordstrand. <Link href="/firmaer/">Se alle i Oslo</Link>.
          </p>
        )}
      </section>
      ...
      <section style={{ marginTop: '2rem' }} className="prose">
        ...
        <h2>Regnskapsmarkedet i Søndre Nordstrand</h2>
        <p>
          Søndre Nordstrand har {firms.length} registrerte regnskapsfirmaer. Bydelen er Oslos sørligste bydel med et voksende lokalt næringsliv. Bydelen har en ung befolkning og mange gründere som starter bedrift.
        ...
        <h2>Næringslivet i Søndre Nordstrand</h2>
        <p>
          Søndre Nordstrand dekker områdene Holmlia, Mortensrud, Bjørndal, Prinsdal og Hauketo. Regnskapsfirmaene i bydelen betjener
          typisk lokale håndverkere, tjenesteytere og småbedrifter som betjener bydelens befolkning. Å velge en lokal regnskapsfører kan gi
          fordeler i form av kortere reisevei til møter, kjennskap til lokale
          næringsforhold og ofte lavere priser enn i sentrum.
        </p>

        <h2>Velge regnskapsfører i Søndre Nordstrand</h2>
        <p>
          Med {firms.length} regnskapsfirmaer i Søndre Nordstrand har du valgmuligheter lokalt.
          ...
          et passende kontor i Søndre Nordstrand, kan du enkelt samarbeide med en
      ...
      <SchemaFAQ items={[
        { q: 'Hvor mange regnskapsfirmaer er det i Søndre Nordstrand?', a: `Det er ${firms.length} registrerte regnskapsfirmaer i Søndre Nordstrand .` },
