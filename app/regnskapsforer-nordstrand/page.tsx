...
export const metadata = seo({
  ...
  description: 'Oversikt over regnskapsførere i Nordstrand, Oslo. Komplett liste med adresser og kontaktinfo. Data fra Brønnøysundregistrene.',
...
export default function RegnskapsforerNordstrandPage() {
  ...
  return (
    <div className="container">
      ...
      <h1 style={{ fontSize: '2rem', marginBottom: '1rem' }}>Regnskapsfører Nordstrand Oslo</h1>

      <p style={{ fontSize: '1.05rem', color: 'var(--muted)', marginBottom: '1.5rem' }}>
        Det finnes {firms.length} registrerte regnskapsfirmaer i Nordstrand i Oslo.
        Nordstrand er en rolig og veletablert bydel sør i Oslo. Bydelen har flere regnskapsfirmaer som betjener lokale bedrifter og næringsdrivende i området.
      </p>

      <div className="stat-grid">
        <div className="stat-box">
          <span className="num">{firms.length}</span>
          <span className="label">Regnskapsfirmaer i Nordstrand</span>
        </div>
        <div className="stat-box">
      ...
      <section style={{ marginTop: '2rem' }}>
        ...
        {firms.length === 0 && (
          <p style={{ color: 'var(--muted)' }}>
            Det er foreløpig ingen regnskapsfirmaer registrert med forretningsadresse i Nordstrand.
