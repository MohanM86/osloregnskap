...
export const metadata = seo({
  ...
  description: 'Oversikt over regnskapsførere i Ullern, Oslo. Komplett liste med adresser og kontaktinfo. Data fra Brønnøysundregistrene.',
...
export default function RegnskapsforerUllernPage() {
  ...
  return (
    <div className="container">
      ...
      <FAQAccordion items={[
        { q: 'Hvor mange regnskapsfirmaer er det i Ullern?', a: `Det er ${firms.length} registrerte regnskapsfirmaer i Ullern ifølge Brønnøysundregistrene.` },
